...
class NMF_Data_Loader:
    def __init__(self, path_to_mat: str, local_data_dir: str):
        self.path_to_mat = path_to_mat
        self.local_data_dir = local_data_dir
        self.patient_id = os.path.splitext(os.path.split(path_to_mat)[1])[0].split("_")[
            0
        ]
    ...
    def generate_all_data(self):
        ...
        w_fname = (
            lambda pat_dir, side, num_syn: pat_dir
            + "/val/W_"
            + str(num_syn)
            + "_"
            + side
